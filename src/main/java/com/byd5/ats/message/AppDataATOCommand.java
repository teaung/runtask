...
public class AppDataATOCommand {
	...
	/**初始化值*/
	public void init(){
		this.serviceNum = 0xFF;
		this.lineNum = 0;
		this.nextZcId = 0;
		this.nextCiId = 0;
		this.nextAtsId = 0;
		this.carLineNum = 0xFF;
		this.carNum = 0;
		this.srcLineNum = 0xFF;
		this.trainNum = 0xFF;
		this.dstLineNum = 0xFF;
		this.dstStationNum = String.valueOf(0xFFFF);
		this.directionPlan = 0xFF;
		this.nextStationId = 0xFFFF;
		this.stationStopTime = 0xFFFF;
		this.skipStationId = 0xFFFF;
		this.skipNextStation = 0xFF;
		this.sectionRunLevel = 0;
		this.detainCmd = 0;
		this.returnCmd =  0;
		this.gotoRailYard = 0;
		this.doorControl = 0xFF;
		this.reserved = 0;
	}
}
